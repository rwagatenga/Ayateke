...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{Auth::user()->name}} This is Where You have to Add Private Taps Information</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{url('/private')}}">
                        {{csrf_field()}}
                    <div class="form-group row">
                            <label for="compname" class="col-sm-4 col-form-label text-md-right">Company Name:</label>

                            <div class="col-md-6">
                                <input id="compname" type="text" class="form-control {{ $errors->has('compname') ? ' is-invalid' : '' }}" value="{{ old('compname') }}" name="compname" required autofocus>
                    ...
                    <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label text-md-right">Full Names:</label>
                        ...
                        <div class="form-group row">
                            <label for="time" class="col-sm-4 col-form-label text-md-right">Water Arrival:</label>

                            <div class="col-md-6">
                                <input id="when" type="text" class="form-control {{ $errors->has('when') ? ' is-invalid' : '' }}" value="{{ old('when') }}" name="when" required autofocus>
                                 @if ($errors->has('when'))
                                    <span class="invalid-feedback" role="alert">
